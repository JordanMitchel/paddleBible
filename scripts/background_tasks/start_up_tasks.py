...
async def run_tasks():
    try:
        ...
        await update_coordinates_collection_using_file("data/csv/biblicalLonLat2_formatted.csv", "LonLats")
        print("Seeding Bible_ASV collection...")
        await insert_bible_store("data/json/asv.json",FileTypeEnum.JSON, "Bible_ASV")
