...
class BibleService:
    ...
    async def get_locations_by_scripture(self, verse: str) -> ResponseModel:
    ...
    async def get_scripture_and_coordinates(self, bible_version, book_num, chapter, verse_num) -> ResponseModel:
        ...
        return await request_locations_using_scripture(scripture.verse[verse_num], self.producer)
