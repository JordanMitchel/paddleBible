...
from backendServices.log_service.src.celery_tasks import process_log
from backendServices.log_service.src.metrics import info_counter, warn_counter, error_counter
from backendServices.shared.utils.config import BROKER_URL, LOG_ROUTING_KEY, LOG_QUEUE, LOG_EXCHANGE
